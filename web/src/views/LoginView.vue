  ...
  <div class="flex min-h-screen items-center justify-center bg-surface px-4">
    <div class="card w-full max-w-md p-8 shadow-xl">
      <div class="mb-6 text-center">
        <div class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-accent/20 text-lg font-bold text-accent">K8</div>
        <h1 class="text-2xl font-semibold text-heading">DrKate</h1>
